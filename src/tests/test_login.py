...
def test_login_successfully(driver, browser):
...
def test_login_empty_username(driver, browser):
    allure.dynamic.tag("Login", browser)
    loginPage.verify_if_is_login_page(driver)
...
def test_login_empty_password(driver, browser):
    allure.dynamic.tag("Login", browser)
    loginPage.verify_if_is_login_page(driver)
    loginPage.fill_username_field(driver, "standard_user")
...
def test_login_user_locked_out(driver, browser):
    allure.dynamic.tag("Login", browser)
    loginPage.verify_if_is_login_page(driver)
...
def test_login_user_invalid(driver, browser):
    allure.dynamic.tag("Login", browser)
    loginPage.verify_if_is_login_page(driver)
...
def test_login_password_invalid(driver, browser):
    allure.dynamic.tag("Login", browser)
    loginPage.verify_if_is_login_page(driver)
    loginPage.fill_username_field(driver, "standard_user123")
